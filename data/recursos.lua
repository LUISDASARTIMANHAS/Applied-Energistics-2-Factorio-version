...
-- receita
{
    ...
    result = {"calculation-processor-press",2},
},
})
...
-- receita
{
    ...
    result = {"engineering-processor-press",2},
},
})
...
-- receita
{
    ...
    result = {"logic-processor-press",2},
},
})
...
{
    type = "recipe",
    name = "silicon-press-recipe-recipe",
    category = "crafting",
    enabled = true,
    ingredients = {
    },
